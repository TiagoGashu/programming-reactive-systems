...
import akka.actor.typed.{ ActorSystem, Behavior, ExtensibleBehavior, SupervisorStrategy, Signal }
...
object SupervisionDemo {
    ...
    private class Restarter[T](initial: Behavior[T], behavior: Behavior[T]) extends ExtensibleBehavior[T] {
        ...
        def receiveSignal(ctx: akka.actor.typed.ActorContext[T], msg: Signal): Behavior[T] =
